  ...
  const fetchCategories = async () => {
    try {
      ...
      setCategories([
        ...
        { _id: "2", name: "Electrical", description: "Licensed electricians" },
        { _id: "3", name: "Cleaning", description: "Home and office cleaning" },
        {
          _id: "4",
          name: "Carpentry",
        ...
        { _id: "6", name: "HVAC", description: "Heating and cooling services" },
      ]);
    } finally {
      setLoading(false);
    }
